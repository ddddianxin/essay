<template>
    <div ref="wrapper" class="collect-wrapper" :style="{height:height+'px'}">
...
<script>
    ...
    export default {
        ...
        methods: {
            initScroll() {
                this.height = document.body.clientHeight - document.getElementById('mHead').offsetHeight-20;//因为顶部有margin,多减20
